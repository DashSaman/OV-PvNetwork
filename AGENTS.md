...
- `v1.0.14` — PRODUCTION VERIFIED / PUBLICATION GATE — `PVN-585` security regression.
  ...
  - Remaining publication gate: docs-only closure merge + final main CI, immutable `v1.0.14` tag/assets, SHA256 and public re-download verification.
