        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            ...
            <select id="edit-protocol" name="protocol" value={formData.protocol} onChange={handleChange}>
              <option value="tcp">{t("ui.f544fb304c83")}</option>
              <option value="udp">{t("ui.e9a6f622e340")}</option>
            </select>
          </div>
          <div className="input-group">
          ...
          gap: '8px'
            ...
            <label htmlFor="edit-status" style={{
            marginBottom: 0
          }}>{t('status_active')}</label>
          </div>
