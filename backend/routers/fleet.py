...
JOBDIR=Path('/var/lib/pvnetwork-panel/fleet-jobs'); JOBDIR.mkdir(parents=True,exist_ok=True); JOBDIR.chmod(0o700)
KNOWN_HOSTS=Path('/var/lib/pvnetwork-panel/fleet_known_hosts')
